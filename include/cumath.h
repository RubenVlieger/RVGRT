...
#define GPU_FUNC         /* Helper functions don't need a keyword */
#define GPU_INLINE       [[always_inline]]
#define KERNEL_FUNC      kernel
#define CONST_MEM        constant
#define DEVICE_MEM       device
#define THREAD_MEM       thread
#define HOST_FUNC        /* Not Applicable */


#define RESTRICT         MTLTexture
#define TEXTURE_OJECT    cudaTextureObject_t
...
#define RESTRICT         void
#define TEXTURE_OJECT    void
...
// Overloaded constructor functions work across all platforms.
